...
세부 사양은 [`docs/PHASE2-5_지시서.md`](PHASE2-5_지시서.md)가 기준이다 (2026-09-25 Phase 2–5 지시서: 포트원, 무료 월 8회, 평가 저장 제한 없음(R2), 연간 수동 갱신). 구현 전에 결정할 항목은 그 문서 상단의 「구현 전 검토 메모」 R1~R13에 정리했다.

| 단계 | 시기 | 상태 |
|---|---|---|
| 2-A 요금 체계 UI + 기능 게이팅 | 2026.11 | 🟡 구현 (`BILLING_ENFORCED_FROM` 미설정으로 배포 · 오픈 시 `2027-02-01` 설정. 월 중간 날짜면 다음 달 1일부터 적용) |
