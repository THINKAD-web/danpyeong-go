    ...
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="mt-10 space-y-10">
        ...
        <Section n="1" title="수집하는 개인정보의 항목 및 수집 방법">
          ...
          <Table
            ...
            rows={[
              [
                "필수",
                "이름(또는 닉네임) 또는 출석번호 중 하나, 응시 답안 및 채점 결과",
          ...
          <List
            items={[
              ...
              <>
                교사가 평가를 <b>&lsquo;출석번호만&rsquo; 모드</b>로 설정하면 학생의 이름은
                수집하지 않고 출석번호(1~99)만 입력받습니다.
              </>,
              "학생의 생년월일·연락처·학교명·기기 식별자·위치정보는 수집하지 않습니다.",
            ]}
          />

          <h3 className="mt-6 font-bold">다. 한눈에 보는 수집 항목 요약</h3>
          <Table
            head={["대상", "수집 항목", "목적", "보유 기간"]}
            rows={[
              ["교사", "이메일, 이름(닉네임)", "회원 식별·서비스 제공", "회원 탈퇴 시까지"],
              [
                "학생",
                "이름 또는 출석번호, 응답·채점 결과",
                "응시·자동 채점·교사용 리포트",
                "학기 단위 (학기 종료 후 이름 익명화)",
              ],
            ]}
          />
        </Section>
        ...
        <Section n="3" title="개인정보의 보유 및 이용 기간">
          <OrderedList
            items={[
              ...
              <>
                <b>교사 계정 삭제 시</b>: 해당 교사가 만든 평가·문항과 그 평가에 응시한{" "}
                <b>학생의 이름·답안·채점 결과를 즉시 함께 삭제</b>합니다.
              </>,
            ]}
          />
        </Section>
        ...
        <Section n="4" title="개인정보의 제3자 제공">
          ...
          <h3 className="mt-6 font-bold">AI 문항 생성 시 외부 AI(Anthropic Claude)로 전송되는 정보</h3>
          <Table
            head={["전송됨", "전송되지 않음"]}
            rows={[
              [
                "학년, 단원명, 교육과정 성취기준, 단원별 출제 조건, 교사가 고른 난이도·문항 수·문항 유형",
                "교사 이메일·이름, 학생 이름·출석번호, 학생 답안·점수 등 모든 개인정보",
              ],
            ]}
          />
          <List
            items={[
              "학생 답안의 채점은 AI를 거치지 않고 단평GO 서버에서 정해진 정답과 비교하여 처리합니다.",
              "가입 전 미리보기(/demo)는 미리 만들어 둔 샘플 문항을 보여주며 외부 AI를 호출하지 않습니다.",
            ]}
          />
        </Section>
        ...
        <Section n="7" title="개인정보의 파기 절차 및 방법">
          <OrderedList
            items={[
              ...
              "교사 계정이 삭제되면 인증 서비스(Clerk)의 삭제 알림을 받는 즉시 교사 정보, 교사가 만든 평가·문항, 해당 평가의 학생 응시 기록(이름·답안·채점 결과)을 하나의 처리 단위로 일괄 삭제합니다.",
              "학기 익명화는 매년 2월 말일·8월 말일에 자동 실행되며, 직전 학기에 마감된 평가의 학생 이름(또는 출석번호)을 무작위 식별값(예: 학생_ab12cd)으로 대체합니다.",
        ...
        <Section n="11" title="개인정보처리방침의 변경">
          ...
          <List
            items={[
              "공고일: 2026년 9월 25일",
              "시행일: 2026년 10월 2일",
              "이전 방침: 2026년 8월 1일 시행 (변경 사항: 출석번호만 모드 추가, 수집 항목 요약표, AI 전송 정보 명시, 계정 삭제 시 파기 절차 구체화)",
            ]}
          />
        </Section>
      </div>
